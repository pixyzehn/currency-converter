...
The library lives in `Sources/CurrencyConverter/` (public API, XML parsing, models). Tests are in `Tests/CurrencyConverterTests/`. `Package.swift` defines the SPM package.
